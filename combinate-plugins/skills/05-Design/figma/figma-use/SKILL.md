...
2. Call `get_screenshot` to check visual correctness. Look closely for cropped/clipped text and overlapping elements.
3. Identify the discrepancy — is it structural or visual?
